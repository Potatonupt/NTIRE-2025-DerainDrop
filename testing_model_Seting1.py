...
parser.add_argument('--eval_in_path_realRainDrop', type=str,default= '/data2/czh/datasets/Test/RainDrop/')
parser.add_argument('--eval_gt_path_realRainDrop', type=str,default= '/data2/czh/datasets/Test/RainDrop/')
...
parser.add_argument('--save_path', type=str,default= '/home/czh/WGWS-Net/experiments/WGWS2fin')
