...
# path setting
parser.add_argument('--experiment_name', type=str,default= "trainDrop3") # modify the experiments name-->modify all save path
parser.add_argument('--unified_path', type=str,default=  '/home/czh/WGWS-Net/experiments/')
#parser.add_argument('--model_save_dir', type=str, default= '/home/czh/WGWS-Net/save_model/')#required=True
...
parser.add_argument('--writer_dir', type=str, default= '/home/czh/WGWS-Net/writer_logs/')
